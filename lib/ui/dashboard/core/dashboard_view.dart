...
class _HomeViewState extends State<DashboardView>
  ...
  dynamic getIndexFromBottonNavigationIndex(int param) {
    ...
    switch (param) {
      case 0:
        ...
        title = Utils.getString(context, 'app_name'); //Utils.getString(context, 'app_name');
        break;
      case 1:
  ...
  Widget build(BuildContext context) {
    ...
    if (isFirstTime) {
      appBarTitle = Utils.getString(context, 'app_name'); //Utils.getString(context, 'app_name');
                    ...
                    if (provider.psValueHolder.loginUserId != null &&
                      ...
                      Visibility(
                        ...
                        child: ListTile(
                            ...
                            title: Text(
                              Utils.getString(context, 'item_entry_city'),
                              style: Theme.of(context).textTheme.bodyText1,
                            ),
                            onTap: () {
                              Navigator.pop(context);
                              Navigator.pushNamed(context, '/itemLocationList');
                            }),
                      ),
                  if (provider != null)
                    if (provider.psValueHolder.loginUserId != null &&

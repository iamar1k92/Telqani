...
class PsColors {
  ...
  static const Color _c_main_color = Color(0xFF4CBE42);
  static const Color _c_main_light_color = Color(0xFFEDF8EC); //FFF0F1);
  static const Color _c_main_dark_color = Color(0xFF4CBE42);
  ...
  static const Color _c_blue_color = Colors.white;
